...
export const SiteMap = () => {
  const [selectedArea, setSelectedArea] = useState<Area | null>(areas[3]); // Area 4 default
                        ...
                        area.connections.map(connId => {
                          ...
                          return (
                            <path
                              ...
                              fill="none"
                              strokeDasharray={area.id === 4 || connId === 4 ? "2,2" : "none"}
